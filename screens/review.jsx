// Review queue + Shared finances (couples)
const ReviewShared = () => {
  return (
    <>
      ...
      <div className="review-grid">
        ...
        <div className="card">
          <div className="card-h">
            <div>
              ...
              <p>Ambigüedades preservadas hasta resolver</p>
            </div>
            <div className="tabs">
          ...
          <ReviewItem
            severity="high"
            title="Cargo $640 sin clasificar"
            desc="Pago a Tarjeta Oro · 20 abr"
            sugg="Posible liquidación de saldo, no gasto del mes."
            who="AM"
          />
          <ReviewItem
            severity="med"
            title="Posible duplicado"
            desc="Mercado Central — $84.50 — 24 abr · 14:32"
            sugg="Coincide con cargo manual del mismo día."
            who="MV"
          />
          <ReviewItem
            severity="med"
            title="Transferencia sin destino"
            desc="$500 desde BBVA · 21 abr"
            sugg="Vincular con obligación 'Ahorro mensual'."
            who="AM"
          />
          <ReviewItem
            severity="low"
            title="Categoría poco frecuente"
            desc="Farmacia San Pablo — $28.10"
            sugg="Anteriormente clasificado como 'Salud'."
            who="—"
          />
          <ReviewItem
            severity="low"
            title="Cargo recurrente nuevo"
            desc="StreamFit — $24.99"
            sugg="¿Crear recurrencia o marcar como fantasma?"
            who="MV"
          />
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <div className="card shared-card">
            <div className="card-h">
              <div>
                <h3>Finanzas compartidas</h3>
                <p>Hogar Martínez · 2 personas</p>
              </div>
          ...
          <div className="card">
            <div className="card-h">
              <div>
                <h3>Compartido este mes</h3>
                <p>Gastos divididos automáticamente</p>
              </div>
            </div>
...
const ReviewItem = ({ severity, title, desc, sugg, who }) => {
    ...
    <div className="review-row">
      ...
      <div className="review-body">
        ...
        <div className="review-sugg">
          <Icon name="lightbulb" size={11} /> {sugg}
        </div>
      </div>
...
const SharedRow = ({ name, who, amount, split }) => (
...
window.ReviewShared = ReviewShared;
