// Icons — minimal stroke set matching reference aesthetic
const Icon = ({ name, size = 16, className, style }) => {
  ...
  switch (name) {
    ...
    case "expense":
      return <svg {...props}><path d="M7 17L17 7M17 7H9M17 7v8"/></svg>;
    case "income":
      return <svg {...props}><path d="M17 7L7 17M7 17h8M7 17V9"/></svg>;
    case "budget":
      return <svg {...props}><path d="M12 2v20M2 12h20"/><circle cx="12" cy="12" r="9"/></svg>;
    case "report":
      return <svg {...props}><circle cx="12" cy="12" r="9"/><path d="M12 3v9l6 3"/></svg>;
    case "recurring":
      return <svg {...props}><path d="M21 12a9 9 0 1 1-3.5-7.1M21 4v5h-5"/></svg>;
    case "account":
    ...
    case "review":
      return <svg {...props}><path d="M12 9v4M12 17h.01"/><path d="M10.3 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/></svg>;
    case "doc":
    ...
    case "trend-up":
      return <svg {...props}><path d="M22 7 13.5 15.5 8.5 10.5 2 17"/><path d="M16 7h6v6"/></svg>;
    case "trend-down":
      return <svg {...props}><path d="M22 17 13.5 8.5 8.5 13.5 2 7"/><path d="M16 17h6v-6"/></svg>;
    case "card":
    ...
    case "btc":
      return <svg {...props}><circle cx="12" cy="12" r="9"/><path d="M9 7v10M9 7h4.5a2.5 2.5 0 1 1 0 5H9M9 12h5a2.5 2.5 0 1 1 0 5H9M11 5v2M11 17v2M14 5v2M14 17v2"/></svg>;
    case "piggy":
      return <svg {...props}><path d="M19 5c-1.5 0-2.8.4-4 1H8a6 6 0 0 0-5.6 4H1a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h2c.4.7 1 1.4 2 2v2a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-1h4v1a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-2.4c.5-.4 1-1 1.4-1.6L21 13a1 1 0 0 0 1-1V8a4 4 0 0 0-3-3"/><path d="M16 11h.01"/></svg>;
    case "filter":
    ...
    case "ghost":
      return <svg {...props}><path d="M9 10h.01M15 10h.01M12 2a8 8 0 0 0-8 8v12l3-3 3 3 2-3 2 3 3-3 3 3V10a8 8 0 0 0-8-8z"/></svg>;
    case "users":
    ...
    case "arrow-up-right":
      return <svg {...props}><path d="M7 17 17 7M7 7h10v10"/></svg>;
    case "arrow-down-right":
      return <svg {...props}><path d="M7 7l10 10M17 7v10H7"/></svg>;
    case "lightbulb":
      return <svg {...props}><path d="M9 18h6M10 22h4M12 2a7 7 0 0 0-4 12.7c.8.6 1.3 1.5 1.3 2.5V18h5.4v-.8c0-1 .5-1.9 1.3-2.5A7 7 0 0 0 12 2"/></svg>;
    case "cash":
      return <svg {...props}><rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="12" cy="12" r="2.5"/><path d="M6 10v.01M18 14v.01"/></svg>;
    default:
